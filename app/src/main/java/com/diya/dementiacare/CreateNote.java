...
public class CreateNote extends AppCompatActivity {
    ...
    public void onBackPressed() {
        Intent setIntent = new Intent(this, Reminder.class);
        ...
        switch(item.getItemId()) {
            case R.id.action_save:
                ...
                if (checkBoxAlarm.isChecked()){
                    ...
                    String alertContent=detail;
                    Log.d("createnotetitle",title);
                    Log.d("createnotedetail",detail);
                    intent.putExtra("notiTitle", alertTitle);
                    intent.putExtra("notiContent", alertContent);
                    ...
                    cv.put(mDbHelper.TIME, timeString);
                    cv.put(mDbHelper.DATE, dateString);
                    intent.removeExtra("notiTitle");
                    intent.removeExtra("notiContent");
                }
                db.insert(mDbHelper.TABLE_NAME, null, cv);

                Intent openMainScreen = new Intent(this, Reminder.class);
                openMainScreen.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(openMainScreen);
                return true;

            case R.id.action_back:
                Intent openMainActivity = new Intent(this, Reminder.class);
